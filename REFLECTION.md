...
https://github.com/joycej003/joycej003.github.io
...
I did not use GenAI. 
I used the automatic ai in visual studio code to help write code when it predicts what words I want to type. For example, when I wanted to add a class, after I manually added the class tag to some sections, it predicted it when I started typing again. I  use ai to quickly write both the open and close tags when it comes up, for example, when I was making the lists, it would predict <li> </li> and I would accept it instead of manually typing it out to be quicker.
